...
L["uplp_class_weapon_lever"] = "Винтовка рычажного действия"
L["uplp_class_weapon_dmr"] = "Марксманская винтовка"
